...
#            continue
    for digi_idx in range(event.digi_nDigi):
        if event.digi_bx[digi_idx] != 0:
            continue
        if dict_roll_digistrip_BX[str(event.digi_rawId[digi_idx])][event.digi_strip[digi_idx]].count(0) > 1:
            print 'Event: ', event.event_eventNumber, ' roll: ', event.digi_rawId[digi_idx] 
            #continue
...
canvas_n_digi_per_roll.Print("n_digi_per_roll_per_evt_bx0_noHitInBXminus1norMinus2.png")
...
canvas_n_digi_per_roll_largeRangeX.Print("n_digi_per_roll_per_evt_largeRangeX_bx0_noHitInBXminus1norMinus2.png")
canvas_n_digi_per_roll_largeRangeX.SetLogy()
canvas_n_digi_per_roll_largeRangeX.Print("n_digi_per_roll_per_evt_largeRangeX_bx0_noHitInBXminus1norMinus2_logy.png")
