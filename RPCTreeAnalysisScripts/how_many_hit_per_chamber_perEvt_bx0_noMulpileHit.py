...
canvas_n_digi_per_roll.Print("n_digi_per_roll_per_evt_bx0_noMultipleHit.png")
...
canvas_n_digi_per_roll_largeRangeX.Print("n_digi_per_roll_per_evt_largeRangeX_bx0_noMultipleHit.png")
canvas_n_digi_per_roll_largeRangeX.SetLogy()
canvas_n_digi_per_roll_largeRangeX.Print("n_digi_per_roll_per_evt_largeRangeX_bx0_noMultipleHit_logy.png")
